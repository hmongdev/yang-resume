...
const About = () => {
    return (
        <div name="about" className="w-full h-full text-white pb-20">
            <div className="text-center mb-10">
                <h2 className="text-4xl md:text-6xl font-medium inline border-b-4 border-gray-500">
                    About
                </h2>
            </div>
            <div className="max-w-screen-lg flex flex-col justify-center items-center text-gray-400 text-md p-4">
                <ul>
